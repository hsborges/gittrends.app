  ...
  <div class="container flex flex-col flex-grow items-center p-4 md:p-16">
    <div class="w-full lg:w-4/5">
      <article>
        ...
        <p>
          GitTrends is a tool created to support developers, project maintainers
          and software engineering researchers by providing useful insights on
      ...
      <article>
        ...
        <div class="me flex flex-col md:flex-row py-8 min-h-32 md:h-56">
          ...
          <div
            class="description flex flex-grow flex-col text-base md:text-lg pt-8 md:pt-0"
          >
      ...
      references: [
        {
          ...
          misc:
            "In 33rd Brazilian Symposium on Software Engineering (SBES), pages 1-10, 2019",
