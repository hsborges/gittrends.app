<template>
  <div
    class="flex flex-wrap justify-between md:justify-start items-center w-full py-4"
  >
    <div
    ...
    return {
      fields: [
        ...
        },
        {
          text: "Homepage",
          icon: "fas fa-home",
          value: this.repository.homepage || this.repository.full_name,
          url:
            this.repository.homepage ||
